...
write.csv(precision_tab_10,"C:/IOT2/RF/Precision50.csv")
write.csv(Recall_tab_10,"C:/IOT2/RF/Recall50.csv")
write.csv(F1_tab_10,"C:/IOT2/RF/F150.csv")
write.csv(Accuracy_tab_10,"C:/IOT2/RF/Accuracy50.csv")



allvars <- data.frame(accrf11_test$overall)
vifvars<- data.frame(accrf21_test$overall)
#RFEvars<- data.frame(accrf31_test$overall)

result10_overall <- cbind(allvars,vifvars)#,RFEvars)

write.csv(result10_overall,"C:/IOT2/RF/Overall_Accuracy_50.csv")
